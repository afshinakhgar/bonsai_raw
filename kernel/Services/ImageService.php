...
class ImageService extends AbstractServices
{
    ...
    public function deletePhotos($photoid,$type='user_photo',$ext='jpg', $dimensions = false)
    {
        ...
        foreach ($defaultDimensions as $keys=>$dimension)
        {
            ...
            $destUrl = $dest.'/'.getImageDirName($photoid,$type).getImageFileName($photoid,$keys,$type).'.'.$ext;
            File::delete($destUrl);
