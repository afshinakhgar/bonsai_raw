...
@section('content')
                ...
                <ul class="todo-list">
                    @foreach($list as $role)
                        ...
                        <!-- General tools such as edit or delete-->
                            <div class="tools">
                                <a href="{{route('admin.role.permission.edit',['id'=>$role->id])}}" class="fa fa-edit"></a>
    ...
    <div class="box-footer clearfix no-border">
        <a href="{{route('admin.role.permission.create')}}" class="btn btn-default pull-left"><i class="fa fa-plus"></i> اضافه کردن دسترسی</a>
    </div>
    </div>
