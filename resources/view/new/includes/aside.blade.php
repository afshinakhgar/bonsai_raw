    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p>{{\Kernel\Facades\Auth::user()->first_name}} {{\Kernel\Facades\Auth::user()->last_name}}</p>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active ">
                <a href="{{route('admin.study.list')}}">
                    <i class="fa fa-cubes"></i> <span>لیست بسته ها</span>
                </a>
            </li>


            <li class="active ">
                <a href="{{route('admin.study.lesson.list')}}">
                    <i class="fa fa-archive"></i> <span>لیست درس ها</span>
                </a>
            </li>


            <li class="active ">
                <a href="{{route('admin.study.exam.list')}}">
                    <i class="fa fa-quote-right"></i> <span>لیست آزمون ها</span>
                </a>
            </li>
            <li class="header">بانک پرسش و پاسخ </li>

            <li class="active ">
                <a href="{{route('admin.study.question.list')}}">
                    <i class="fa fa-question"></i> <span>لیست پرسش ها</span>
                </a>
            </li>
            <li class="active ">
                <a href="{{route('admin.study.answer.list')}}">
                    <i class="fa fa-book"></i> <span>لیست پاسخ ها</span>
                </a>
            </li>
            {{--<li class="treeview">--}}
                {{--<a href="#">--}}
